...
var Tabs = Class.create({
    ...
    findTabElementFromAnchor: function(anchor) {
        ...
        while (element && element.tagName.toUpperCase() != this.options.tabTagName.toUpperCase()) {
...
Tabs.Tab = Class.create({
    ...
    setupNavigation: function() {
        ...
        var ulElement = new Element("ul", {
            "class": this.parent.options.navigationClass
        });

        if (!this.isFirst()) {
            var prevElement = new Element("li", {
                "class": this.parent.options.previousClass
            });
        ...
        if (!this.isLast()) {
            var nextElement = new Element("li", {
                "class": this.parent.options.nextClass
            });
